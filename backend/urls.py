...
from backend.views import AccountRegister, AccountLogin, GoodsUpload, BasketView, ContactView, OrderView, \
    PartherState, PartnerOrders, AccountConfirm, AccountDetails, CategoryView, ShopView, ProductInfoView
